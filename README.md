					...
					<tr>
						...
						<td width="60%">
							<font face="Verdana" size="4"
								...
								website.
								<hr color="black">
								sunana sharma from government women  
                engineering college Ajmer(Rajasthan).I
								loves to solve programming problems
								in most efficient ways.
                Apart from that I have completed 
                'Basics of HTML/CSS for beginners '
                training from open weaver.
							<hr color="black">

								I do my work mainly in C-Language,
								C++ and PyThon . C++ and Data Structure
